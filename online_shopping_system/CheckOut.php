...
<option>Tumkur
        ...
        <tr>
          <td> Contact </td>
          <td><input name="stel2" type="tel" class = "in9" id="stel2" placeholder="Contact Phone" tabindex="9" maxlength = 10 onblur = "numb()" required/></td>
...
foreach ($_SESSION["cart"] as $item)
{
	...
	echo "</tr>";
	echo "<tr style = 'background-color:#e8e9e7;'> <td colspan = 4 align = right>Grand Total : <td align = 'center'> <font style = 'font-family:Rupee Foradian'><strong> Rs. </font>".$tp2;;
	echo "<td> </tr></table>";	
?>          </td>
        </tr>
        <tr>
