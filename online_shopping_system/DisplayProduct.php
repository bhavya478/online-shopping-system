...
echo "</tr> <tr>";
echo " <td>Price<td><font style = 'font-family:Rupee Foradian'>Rs. </font> <input type = 'text' class = 'in7' name = 'p' value = '".$row5[4]."' readonly> </td>";
echo "</tr> <tr>";
...
<a href ='DisplayProduct.php?p=$row[1]&p2=$row[0]&p3=$row[2]'><img src ='".$row['Imagepath']."'> </a><br> <font style = 'font-family:Rupee Foradian'>Rs. </font>".$row['Price'];
